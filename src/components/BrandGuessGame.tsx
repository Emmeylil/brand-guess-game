...
const questions: Question[] = [
  { id: 1, image: itel, correctAnswer: "Itel", acceptableAnswers: ["itel", "itel store", "Itel Store"] },
  { id: 2, image: hisense, correctAnswer: "Hisense", acceptableAnswers: ["hisense", "hisense store", "Hisense Store"] },
  { id: 3, image: glamstar, correctAnswer: "Glamstar", acceptableAnswers: ["glamstar", "Glamstar store", "glamstar Store"] },
  { id: 4, image: xiaomi, correctAnswer: "Xiaomi", acceptableAnswers: ["xiaomi", "Xiaomi store", "xiaomi Store"] },
  { id: 5, image: Maybelline, correctAnswer: "Maybelline", acceptableAnswers: ["maybelline", "maybelline store", "Maybelline Store"] },
];
        ...
        <Card className="p-6 mb-6 bg-gradient-to-br from-card to-card/80 border-jumia/20">
          <div className="text-center space-y-6">
            ...
            <div className="relative w-64 h-64 mx-auto bg-white rounded-lg p-4 shadow-lg">
              <img src={question.image} alt="Brand product" className="w-full h-full object-contain rounded" />
            </div>
          </div>
        </Card>
            ...
            <div className="mt-4 p-4 rounded-lg bg-muted">
              <p className="text-sm text-muted-foreground">
                {userAnswer.toLowerCase().trim() &&
                  questions[currentQuestion].acceptableAnswers.some(
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Welcome {user?.name}! Test your brand knowledge</p>
        </div>
        ...
        <Tabs defaultValue="game" className="w-full">
          ...
          <TabsContent value="game">{renderGameContent()}</TabsContent>
